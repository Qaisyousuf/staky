    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          ...
          <Link href="/admin?tab=posts&filter=unpublished" className="flex items-center gap-1 text-xs text-[#0F6E56] hover:underline">
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          ...
          <Link href="/admin?tab=requests" className="flex items-center gap-1 text-xs text-[#0F6E56] hover:underline">
            View all <ArrowRight className="h-3 w-3" />
          </Link>
        </div>
